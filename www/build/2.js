...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu__ = __webpack_require__(699);
...
var MenuPage = /** @class */ (function () {
    ...
    MenuPage.prototype.onClickNotes = function () {
        this.app.getActiveNav().push("CategoryPage");
    };
    MenuPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-menu',template:/*ion-inline-start:"/Users/prashantjain/Desktop/Project/plugins and old helper applications/pointofsale/src/pages/menu/menu.html"*/'<!--\n  Generated template for the MenuPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header class="headerBoxCls">\n  <ion-navbar>\n    <ion-title></ion-title>\n  </ion-navbar>\n  <div>\n    <ion-searchbar\n    [(ngModel)]="myInput"\n    [showCancelButton]="shouldShowCancel"\n    (ionInput)="onInput($event)"\n    (ionCancel)="onCancel($event)">\n  </ion-searchbar>\n  </div>\n</ion-header>\n<ion-content >\n    <ion-grid class="main-grid">\n\n        <ion-row class="item-row">\n          <ion-col class="col" (click)="onClickNotes()">\n            <h4>Shift 1</h4>\n            <img src="assets/images/case-list-icon.png" class="logo-case-list">\n          </ion-col>\n          <ion-col class="col" (click)="onClickNotes()">\n            <h4>Shift 2</h4>\n            <img src="assets/images/calendar-icon.png" class="logo-calendar">\n          </ion-col>\n        </ion-row>\n    \n        <ion-row class="item-row">\n          <ion-col class="col" (click)="onClickNotes()">\n            <h4>Shift 3</h4>\n            <img src="assets/images/notes.png" class="logo-notes">\n          </ion-col>\n          <ion-col class="col" (click)="onClickNotes()">\n            <h4>Shift 4</h4>\n            <img src="assets/images/to-dos.png" class="logo-to-dos">\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/Users/prashantjain/Desktop/Project/plugins and old helper applications/pointofsale/src/pages/menu/menu.html"*/,
        }),
