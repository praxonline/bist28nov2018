...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__category__ = __webpack_require__(692);
...
var CategoryPage = /** @class */ (function () {
    function CategoryPage(dbProvider, _service, platform, viewCtrl, toastCtrl, appCtrl, alertCtrl, loadingCtrl, builder, menuCtrl, navCtrl, navParams) {
    ...
    CategoryPage.prototype.openShoppingList = function () {
        this.appCtrl.getRootNav().push("ItemsPage", { MenuData: this.catItems });
    };
    CategoryPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CategoryPage');
    };
    CategoryPage.prototype.onClickNotes = function (obj) {
        var _this = this;
        this.catItems = [];
        if (obj.isMenu == 1) {
    ...
    CategoryPage.prototype.showToast = function (message, duration) {
    ...
    CategoryPage.prototype.loadItems = function (obj) {
        var _this = this;
